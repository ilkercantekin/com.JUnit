...
public class C03_WindowHandle {
    ...
    public void test01() throws InterruptedException {
        ...
        String expectedIkınciSafyaYazisi="Elemental Selenium";
        String actualIkinciSayfaYazisi=driver.findElement(By.xpath("//h1[text()='Elemental Selenium']")).getText();
        Assert.assertEquals(expectedIkınciSafyaYazisi,actualIkinciSayfaYazisi);
        // ilk sayfaya geri donup sayfadaki yazinin
        // "An iFrame containing the TinyMCE WYSIWYG Editor" oldugunu test edin
        driver.switchTo().window(ilksayfaWHD);
        String expectedKelime="An iFrame containing the TinyMCE WYSIWYG Editor";
